  ...
  <form id="frmVertraging">
    <table width="100%" border="0" cellspacing="10">
      <tr>
        <!--<td>Van</td>-->
        <td>
		<input  id="lstDepartureStations" required="true" type="text" list="stations" name="departureStation"  class="required" style="width:90%" placeholder="Vertrekstation"/>
	</td>
      ...
      <tr>
       <!-- <td>Naar</td>-->
        <td>
		<input  id="lstArrivalStations" required="true" type="text" list="stations" name="arrivalStation" style="width:90%"  placeholder="Aankomststation"/>
			</td>
      </tr>
    <!--  <tr>
      <!--  <td>Datum</td>
	...
	<tr>
	  <td>
        ...
        <td ><input  type="text" id="lstHour"  value="23"  name="lstHour" style="float:left; width:40px;"   style="float:left;"/> <span style="float:left; font-size:1.5em;">&nbsp;uur&nbsp;</span>
		<input  type="text" id="lstMinutes" value="48"  name="lstMinutes" style=" width:40px;"  />
     </td>
	 </tr>
...
<tr>
<td width="100%">
<!-- <input type="button"  id="btnAlternativeRoute" name="btnAlternativeRoute" value="alternatieve route?"  style="width:90%">-->
	<!--<label for="flip-1" style="float:left;padding-top:10px;padding-right:60px;">alternatieve route?</label>
<select name="flip-1" id="flip-1"  data-role="slider">
	...
	<option value="on">Ja</option>
      ...
      <tr>
       <!-- <td>Vertraging</td>-->
        <td width="100%" >
		<!--<input  id="nmbrHour" type="number"  name="nmbrHour"  value="15" style="width:30px;float:left;margin-right:10px;" /> <span style="font-size:1.6em;">minuten</span>-->
      ...
      <tr>
	    ...
	    <td width="100%">
			<input  id="btnSubmit" type="button"  data-parameter="foobarshow" class="btn-orange"  data-theme="e" style="width:90%" name="btnSubmit" value="Registreer vertraging" /></td>
